...
window.onload = function() {
  ...
  donationStatus.innerHTML = "<i class='fa fa-window-close red'></i> We need <span class='red'>$" + (User.donationGoal - User.donationCollect) + "</span> to reach our Donation Goal";
  ...
  donate.onclick = function(e) {
    ...
    donationStatus.innerHTML = User.donationGoal - newDonationNumber > 0 ? "<i class='fa fa-window-close red'></i> We need <span class='red'>$" + (User.donationGoal - newDonationNumber) + "</span> to reach our Donation Goal" : "<i class='fa fa-exclamation-circle green'></i> Our campaign has been funded";
